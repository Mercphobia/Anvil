package dev.anvil.ade.agent.memory
 ...
 *   <project_root>/.anvil/memory.md     -> loaded into system prompt
 *   <project_root>/.anvil/history.jsonl -> append-only audit log,
...
class MemoryStore(private val projectRoot: File) {
    ...
    private val dir = File(projectRoot, ".anvil")
